...
export function Navbar() {
  ...
  const isReservationsActive = pathname?.startsWith('/dashboard');
        ...
        <div className="flex items-center gap-10 text-sm font-medium">
          ...
          {user ? (
            <>
              <Link
                href="/dashboard"
                className={`flex items-center gap-2 transition-colors ${isReservationsActive ? 'text-white font-bold underline decoration-indigo-500 decoration-2 underline-offset-4' : 'text-neutral-400 hover:text-white'}`}
              >

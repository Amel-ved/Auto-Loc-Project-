...
export default function CarsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 w-full">
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-white mb-4 inline-block border-b-2 border-indigo-500 pb-2">Available Cars</h1>
        <p className="text-neutral-400 text-lg">Browse our collection of premium cars ready for your next trip.</p>
      </div>

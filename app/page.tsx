        ...
        >
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              Browse the Fleet <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </span>
          </Link>
          <Link 
            href="/login" 
          ...
          <div>
            ...
            <div className="space-y-8">
              {[
                ...
                { step: "02", title: "Select your vehicle", desc: "Browse our premium fleet and pick your dates." },
